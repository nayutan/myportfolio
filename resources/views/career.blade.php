...
<br>
          ...
          また、テスト設計、テストレビュー、レポートの作成についても対応した。
        </div>
    </div>
    <div class="row mt-1">
        <div class="col-2 skill2">
        ...
        <div class="col-8 skill2">
          ...
          担当している案件に対して、進行状況の確認や、問題・トラブルの解消、OJTでのリーダー指導を実施。<br>
          担当案件の状況によって、チームの人員調整や、作業見通しの出し直しによる追加コストの相談等を行う。<br>
          OJT以外にも、研修資料作成や資料を用いての研修の実施、リーダー候補の指導や面接を担当。
        </div>
    </div>
    <div class="row mt-1">
        <div class="col-2 skill2">
        ...
        <div class="col-8 skill2">
          社内の情報共有や、膨大なデータの取り扱いに関して、毎日の作業で発生しているロスに着目し、そのロスを解消するための相談や提案を行った。最終的に、情報システム部門のCEOへの提案を行い、全国の拠点にそれぞれファイルサーバーを設置する運びとなり、毎日の業務で平均一人あたり1.5時間分のロスの解消に成功<br>
          また、社内での情報の共有やタスクの管理が各人でバラバラで、情報伝達齟齬によるトラブルが発生していたため、Redmineを利用したタスク管理を実施。現在でも継続して利用しており、担当人員が休んだ場合でも問題なく業務を遂行できる下地となった。
        </div>
    </div>
    <div class="row mt-1">
        <div class="col-2 skill2">
...
<br>
          2017年11月の復帰以降、経過観察のための通院を覗いては1日8時間の通常勤務を休むことなく継続。<br>
          現在は投薬量も減り、寛解も間近の見込み。
        </div>
    </div>
</div>
